...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>FindComment/frontlist">评论信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评论id:</div>
		<div class="col-md-10 col-xs-6"><%=findComment.getCommentId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">被评寻人信息:</div>
		<div class="col-md-10 col-xs-6"><%=findComment.getFindPersonObj().getPersonName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评论内容:</div>
		<div class="col-md-10 col-xs-6"><%=findComment.getContent()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评论用户:</div>
		<div class="col-md-10 col-xs-6"><%=findComment.getUserObj().getName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">评论时间:</div>
		<div class="col-md-10 col-xs-6"><%=findComment.getCommentTime()%></div>
	</div>
	<div class="row bottom15">
