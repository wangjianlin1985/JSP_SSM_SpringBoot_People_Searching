...
<jsp:include page="../header.jsp"></jsp:include>
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>FindPerson/<%=findPerson.getFindPersonId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=findPerson.getPersonPhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="findPersonEdit('<%=findPerson.getFindPersonId() %>');" style="display:none;">修改</a>
			        <a class="btn btn-primary top5" onclick="findPersonDelete('<%=findPerson.getFindPersonId() %>');" style="display:none;">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="findPersonQueryForm" id="findPersonQueryForm" action="<%=basePath %>FindPerson/frontlist" class="mar_t15" method="post">
