		...
		<div class="row"> 
		  ...
		  <div class="form-group">
			  ...
			  <div class="form-group">
			  	...
			  	<span onclick="ajaxFindTypeModify();" class="btn btn-primary bottom5 top5">修改</span>
			  </div>
		</form> 
...
$(function(){
        ...
        new WOW().init();
    findTypeEdit("<%=request.getParameter("findTypeId")%>");
 })
 </script> 
</body>
</html>
