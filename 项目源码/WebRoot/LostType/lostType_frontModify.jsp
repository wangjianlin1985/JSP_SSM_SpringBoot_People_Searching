		...
		<div class="row"> 
		  ...
		  <div class="form-group">
			  ...
			  <div class="form-group">
			  	...
			  	<span onclick="ajaxLostTypeModify();" class="btn btn-primary bottom5 top5">修改</span>
			  </div>
		</form> 
...
$(function(){
        ...
        new WOW().init();
    lostTypeEdit("<%=request.getParameter("lostTypeId")%>");
 })
 </script> 
</body>
</html>
