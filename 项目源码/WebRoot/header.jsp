...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">网络寻亲网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>FindPerson/frontlist">寻人信息</a></li>
                <!-- 
                <li><a href="<%=basePath %>NativePlace/frontlist">籍贯</a></li>
                <li><a href="<%=basePath %>FindType/frontlist">寻找类型</a></li>
                <li><a href="<%=basePath %>LostType/frontlist">失踪类型</a></li>
                <li><a href="<%=basePath %>FindComment/frontlist">评论</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>FindPerson/findPerson_userFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布寻亲信息</a></li>
                        <li><a href="<%=basePath %>FindPerson/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的寻亲信息</a></li>
