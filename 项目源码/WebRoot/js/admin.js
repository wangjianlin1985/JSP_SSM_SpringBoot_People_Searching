		       ...
		       text: "寻人信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "FindPerson/findPerson_add.jsp"
			    	   	},
			    		{
			    	   		text: "寻人信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "FindPerson/findPerson_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "籍贯管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "NativePlace/nativePlace_add.jsp"
			    	   	},
			    		{
			    	   		text: "籍贯管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "NativePlace/nativePlace_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "寻找类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "FindType/findType_add.jsp"
			    	   	},
			    		{
			    	   		text: "寻找类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "FindType/findType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "失踪类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "LostType/lostType_add.jsp"
			    	   	},
			    		{
			    	   		text: "失踪类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "LostType/lostType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "评论管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "FindComment/findComment_add.jsp"
			    	   	},
			    		{
			    	   		text: "评论管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "FindComment/findComment_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
